@extends('eshop.layouts.app')
    @section('header')
        <h1 class="display-4 fw-bolder">Produk Detail</h1>
    @endsection
    @section('content')
    <!-- Product section-->
    <section class="py-5">
                ...
                <div class="col-md-6">
                    ...
                    <div class="fs-5 mb-5">
                        ...
                        @if($product->price_before_discount)
                            <span class="text-muted text-decoration-line-through">{{ "Rp " . number_format($product->price_before_discount, 0, ",", ".") }}</span>
                    ...
                    <div class="d-flex">
                        <form action="{{ route('eshop.order.store', $product) }}" method="POST">
                            @csrf
