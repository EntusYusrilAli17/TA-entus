    ...
    <div class="container-fluid relative">
        <div class="grid grid-cols-1">
            <div class="lg:col-span-4">
                <div class="flex flex-col min-h-screen md:px-12 py-4 px-3">
                    <!-- Start Logo -->
                    ...
                    <div class="text-center my-auto">
                        <div class="w-full max-w-sm m-auto px-6 py-8 bg-white dark:bg-slate-900 rounded-md shadow-lg shadow-slate-500 dark:shadow-gray-800">
                            <div class="grid grid-cols-1">
                                <h5 class="text-black mb-8 text-xl dark:text-white font-medium">Signup</h5>
                                <form method="POST" action="{{ route('register') }}" class="text-left">
                                    @csrf
                                    <div class="grid grid-cols-1">
                                        <div class="mb-4">
                                            <label class="dark:text-white" for="RegisterName">Your Name:</label>
                                            <input id="RegisterName" name="name" type="text" class="form-input mt-3" placeholder="Harry">
                                            @error('name')
                                        ...
                                        <div class="mb-2">
                                            ...
                                            @enderror
                                            <input id="LoginPasswordConfirmation" name="password_confirmation" type="password" class="form-input mt-3" placeholder="Confirm Password:">
                                        ...
                                        <div class="mb-4">
                                            <div class="form-checkbox flex items-center mb-0">
                                                ...
                                                <label class="form-check-label text-slate-400 ms-2 whitespace-nowrap" for="AcceptT&C">I Accept <a href="javascript:void(0)" class="text-violet-600">Terms And Condition</a></label>
                                            </div>
                                        </div>

                                        <div class="mb-4">
                                            <button type="submit" class="btn bg-violet-600 hover:bg-violet-700 border-violet-600 hover:border-violet-700 text-white rounded-md w-full">Register</button>
                                        </div>

                                        <div class="text-center">
                                            <span class="text-slate-400 mr-2">Already have an account ? </span> <a href="{{ route('login') }}" class="text-black dark:text-white font-bold"> Sign in</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
